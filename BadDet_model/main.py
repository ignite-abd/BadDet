...
parser.add_argument('--cuda', type=int, default=0, help='Which GPU to run on (-1 for using CPU, 9 for not specifying which GPU to use.)')
...
parser.add_argument('--b_sz', type=int, default=100)  #100  3275
